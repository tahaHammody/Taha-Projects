...
public class add_school_admin_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_school_admin);
        ...
        arrow5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(add_school_admin_activity.this, all_schools_activity.class);
