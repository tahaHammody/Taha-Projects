...
public class add_class_teacher_activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_class_teacher);
        ...
        addBtn = (Button) findViewById(R.id.updateBtn5);
        ...
        arrow9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(add_class_teacher_activity.this , teacher_classes_activity.class);
